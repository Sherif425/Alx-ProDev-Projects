# Project: 0x03. Shell, init files, variables and expansions | Cairo Intranet
...
-   Weight: 1
-   Project over - took place from Jul 28, 2025 7:00 AM to Aug 4, 2025 7:00 AM
-   An auto review will be launched at the deadline

#### In a nutshell…

-   **Auto QA review:** 32.5/70 mandatory & 5.0/20 optional
-   **Altogether:**  **58.04%**
    -   Mandatory: 46.43%
    -   Optional: 25.0%
    -   Calculation:  46.43% + (46.43% \* 25.0%)  == **58.04%**
...
-   [The alias Command](/rltoken/1Z3nYPjmidqQJXcWQ9Fkug "The alias Command")
